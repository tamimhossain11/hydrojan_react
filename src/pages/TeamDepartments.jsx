...
import AdvisorMentor from "../components/Team/AdvisorMentor";
import LeadMember from "../components/Team/LeadMember";

// 🌊 Reusable Ocean Wave Component
const OceanWave = () => {
  return (
    <Plane
      args={[100, 100, 64, 64]}
...
const TeamDepartments = () => {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden text-white bg-[#050b1e]">
      ...
      {/* 🧾 Foreground Content */}
      <div className="relative z-10 p-6 md:p-10 space-y-16">
        <AdvisorMentor />
        <LeadMember />
      </div>
    </div>
